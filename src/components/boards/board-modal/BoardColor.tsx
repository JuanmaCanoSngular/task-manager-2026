      ...
      {BOARD_COLORS.map((color) => {
        ...
        return (
          <button
            ...
            className={`w-8 h-8 rounded-full transition-transform duration-150 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${
              selected
