...
export const ToggleTheme = () => {
  ...
  return (
    ...
    >
      <button
        className={`flex items-center justify-center w-1/2 px-3 py-2 rounded-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
          isDark
            ? 'bg-white text-slate-900 shadow-md border-2 border-indigo-500'
